-- Bossy MVP Schema Migration
-- This migration creates the core tables for the Bossy accountability product
...
-- Indexes for performance (IF NOT EXISTS is safe)
...
-- Row Level Security (RLS) - Enable RLS (safe to run multiple times)
-- In Postgres, enabling RLS when already enabled is a no-op
