                ...
                <form action={formAction} className="space-y-8">
                    ...
                    <div className="space-y-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                        ...
                        <RadioGroup
                            ...
                            required
                        >
                            <div className={`flex items-center space-x-3 p-3 rounded-lg border-2 transition-all cursor-pointer ${timeHorizonState === '14'
                            ...
                            <div className={`flex items-center space-x-3 p-3 rounded-lg border-2 transition-all cursor-pointer ${timeHorizonState === '30'
                                    ? 'border-primary/30 bg-primary/5 hover:bg-primary/10'
                                    : 'border-gray-200 hover:border-primary/30 hover:bg-white'
                                }`}>
                            ...
                            <div className={`flex items-center space-x-3 p-3 rounded-lg border-2 transition-all cursor-pointer ${timeHorizonState === '60'
                                    ? 'border-primary/30 bg-primary/5 hover:bg-primary/10'
                                    : 'border-gray-200 hover:border-primary/30 hover:bg-white'
                                }`}>
